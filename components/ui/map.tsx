...
export function WorldMap({
    ...
    // Calculate animation timing - faster stagger for fluid unidirectional flow
    const staggerDelay = 0.15;
    const totalAnimationTime = dots.length * staggerDelay + animationDuration;
    const pauseTime = 0.5; // Short pause before restarting for continuous flow
    const fullCycleDuration = totalAnimationTime + pauseTime;

    return (
        <div className={`w-full aspect-[2/1] md:aspect-[2.5/1] lg:aspect-[2/1] dark:bg-black bg-transparent rounded-lg relative font-sans overflow-hidden ${className}`}>
            <Image
